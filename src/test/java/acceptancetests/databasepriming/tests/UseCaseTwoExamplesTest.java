package acceptancetests.databasepriming.tests;

import acceptancetests.databasepriming.givens.GivenTheDatabaseContains;
import acceptancetests.databasepriming.givens.SpeciesInfoRecord;
import acceptancetests.databasepriming.testinfrastructure.AcceptanceTest;
...
import static acceptancetests.databasepriming.givens.SpeciesInfoRecord.SpeciesInfoRecordBuilder.speciesInfoRecord;
...
public class UseCaseTwoExamplesTest extends AcceptanceTest implements WithParticipants {
  ...
  private GivenTheDatabaseContains givenTheDatabaseContains() {
    GivenTheDatabaseContains givenTheDatabaseContains = new GivenTheDatabaseContains(dataSource);
